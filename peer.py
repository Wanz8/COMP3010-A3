...
def verify_new_block(blockchain, new_block):
    ...
    if new_block["minedBy"] == None or new_block["minedBy"] == "None":
        return False
...
class Peer:
    ...
    def do_consensus(self):
        ...
        try:
            ...
            for peer_addr in self.peers:
                ...
                if data["height"] == None:
                    continue
                if data["hash"][-1 * DIFFICULTY :] != "0" * DIFFICULTY:
                    continue
    ...
    def send(self, msg, addr):
        ...
        try:
            ...
            print("Sending message failed when send to {}".format(addr))
    ...
    def heartbeat(self):
        ...
        while is_exit == False:
            ...
            for peer_addr, last_seen in self.peers.items():
                ...
                ).total_seconds() < heartbeat_interval * 4:
                    msg = {
                        "type": "GOSSIP",
                        "host": self.addr[0],
                        "port": self.addr[1],
